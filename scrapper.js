...
const cols = [
    ['Price to Earning', 'PEG Ratio', 'Price to Sales', 'EVEBITDA', 'Interest Coverage Ratio', 'Debt to equity', 'Current ratio', 'Return on equity', 'Return on equity preceding year', 'Average return on equity 3Years', 'Average return on equity 5Years', 'Return on capital employed', 'Return on capital employed preceding year', 'Average return on capital employed 3Years'],
